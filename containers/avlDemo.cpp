...
void AVLDemo() {
    ...
    // Caso 1: insercion ascendente (provoca rotaciones izquierda)
    ...
    // Caso 2: insercion descendente (provoca rotaciones derecha)
    ...
    // Caso 3: insercion mixta (combina LL, RR, LR, RL)
    ...
    // Caso 4: copy constructor preserva altura
