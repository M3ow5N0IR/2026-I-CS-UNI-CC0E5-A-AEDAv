...
// BTreeTrait: reusa BaseTrait
template <typename T>
struct AscendingBTreeTrait  : public BaseTrait<VectorNode<T>, less<T>>    {};

template <typename T>
struct DescendingBTreeTrait : public BaseTrait<VectorNode<T>, greater<T>> {};
